...
<div class="col-md-6" style="margin-left:25%; margin-top:11%">
    ...
    <table class="table table-dark table-striped table-hover">
        ...
        $records= mysqli_query($con, "SELECT * FROM student where userid!='admin'"); //Fetch
        while($data = mysqli_fetch_array($records))
        {
            ...
            <tr>
                ...
                <td><a href="edit.php?id=<?php echo $data['userid'];?>"><button type="button" class="btn btn-primary">
                ...
                <td><a href="delete.php?id=<?php echo $data['userid'];?>"> <button type="button" class="btn btn-danger">
    ...
    <p>To Edit/Delete Admin Details Please Contact Developer</p>
    <?php mysqli_close($con); //Close Connection ?>
    <table>
    <tr>
    <td><center><button class="btn btn-success" type="button" style="display:inline;" ><a href="add.php"style="color:white; text-decoration:none">Add a Student</a></button></center></td>
    <td><br></td>
    <td></td>
    <td></td>
